       ...
       py-3 px-12 animate__animated animate__zoomIn"
        ...
        <div>
          <div className=" relative w-screen overflow-hidden h-screen bg-base1 bg-cover flex md:px-24 lg:px-56 items-center font-prom">
            ...
            <div className="">
              <img
                className=" invisible md:visible animate-movingUpandDown z-30 absolute w-[30vw] top-[15vh] right-[10vw]"
          ...
          <div>
            <footer class="bg-amber-200 text-center text-white ">
              ...
              <div class="p-4 text-center text-black bg-amber-400 ">
                © 2023 Copyright :
                <a class="text-black" href="https://www.kmitl.ac.th/">
                  {" "}
                  KMITL
                </a>
              </div>
